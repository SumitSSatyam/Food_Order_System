...
<div class="main-content">
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            //Cheak weather we have data in database or not
            if ($count > 0) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($image_name != "") {
                                // echo $image_name;
                                ?>
                                <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="no image found"
                                    width="100px">
                                <?php
                            } else {
                ...
                //We do not have data 
                //we will display the massege inside table
                ?>
                <tr>
                    <td colspan="6">
