...
<div class="main-content">
    <div class="wrapper">
        ...
        <br><br>
        <?php
        //cheak weather id is set or not
        if (isset($_GET['id'])) {
            //get the order detail
            $id = $_GET['id'];
            //get all other detail based on this id
            //query to get other detail
                ...
                <tr>
                    ...
                    <td>
                        <select name="status">
                            ...
                            <option <?php if ($status == "Delevered") {
                                echo "selected";
                            } ?>value="Delivered">Delevered
                            </option>
...
<?php 
//cheak weather update button is clicked or not
